...
int main() {
    ...
    // Тестирование выражений с действительными числами
    ...
    // Тестирование выражений с комплексными числами
    ...
    map<string, complex<double> > cvariables;
    cvariables["z"] = complex<double>(1.0, -1.0);
